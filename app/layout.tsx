...
import { Geist, Geist_Mono, JetBrains_Mono, Days_One, Inter } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="ru" dir="ltr" className="h-full">
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} ${jetBrainsMono.variable} ${daysOne.variable} ${inter.variable} antialiased`}>
        <WarningPopup />
        {children}
      </body>
    </html>
